...
alias cleanLocalBranches="node $SHELL_ALIAS_DIR/scripts/clean-local-branches.mjs"
alias generateRelease="node $SHELL_ALIAS_DIR/scripts/supermood/create-release.mjs"
